...
/**
 * This system creates Kallisti component objects for KComputers-added Terasology components.
 *
...
public class KallistiPeripheralSystem extends BaseComponentSystem {
    ...
    @ComponentRule
    public static PeripheralOCGPU createGPUFromComponent(MachineOpenComputers machine,
                                                         KallistiOpenComputersGPUComponent component) {
        return new PeripheralOCGPU(machine, component.width, component.height, OCGPURenderer.genThirdTierPalette());
    }

    @ReceiveEvent
    public void createTransposerPeripheral(KallistiAttachComponentsEvent event, EntityRef ref, BlockComponent block,
    ...
    @ReceiveEvent
    public void createEEPROMAssetedComponent(KallistiAttachComponentsEvent event, EntityRef ref,
                                             KallistiEEPROMAssetedComponent component) {
    ...
    @ReceiveEvent
    public void createFilesystemAssetedComponent(KallistiAttachComponentsEvent event, EntityRef ref,
                                                 KallistiFilesystemAssetedComponent component) {
        KallistiArchive archive = CoreRegistry.get(AssetManager.class)
                .getAsset(new ResourceUrn(component.assetName), KallistiArchive.class)
                .get();
    ...
    @ReceiveEvent
    public void createMachineOpenComputersComponent(KallistiAttachComponentsEvent event, EntityRef ref,
                                                    KallistiMachineOpenComputersComponent component) {
        event.addComponent(ref, component);
    }

    @ReceiveEvent
    public void createMemoryComponent(KallistiAttachComponentsEvent event, EntityRef ref,
                                      KallistiMemoryComponent component) {
    ...
    @ReceiveEvent
    public void createOCGPUComponent(KallistiAttachComponentsEvent event, EntityRef ref,
                                     KallistiOpenComputersGPUComponent component) {
        event.addComponent(ref, component);
    }
