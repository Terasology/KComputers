...
/**
 * Asset type used for creating Kallisti-ready OCFont objects from ".hex"-format fonts.
 * <p>
 * It is imperative that the font files be named in the style of "[name]-[width]x[height].hex", for example
 * "unicode-8x16.hex" for an 8x16-glyph font file.
 * <p>
