 ...
 * <p>
 * This is a bit of a workaround for directly missing functionality in the Terasology engine as of writing. It should
 * probably be replaced with an in-engine solution for achieving the same thing (dynamic mesh rendering in a block
 * space).
 * <p>
 * Generally, the intended use is to have unique keys for each mesh entity (MeshComponent) you wish to render, and
 * manage those using the provided methods.
 */
